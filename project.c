 ...
 * Main file
 *
 * Author: Peter Sutton. Modified by Parampreet Singh
 */ 
...
void splash_screen(void) {
	...
	move_cursor(10,12);
	printf_P(PSTR("CSSE2010 project by Parampreet Singh roll no: 456232"));
	
	// Output the scrolling message to the LED matrix
	// and wait for a push button to be pushed.
	ledmatrix_clear();
	while(1) {
		set_scrolling_display_text("ASTEROIDS project by Parampreet 45522325", COLOUR_GREEN);
